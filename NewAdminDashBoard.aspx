  ...
  top: -8px;">
			<a id="set-trigger">
			 ...
			 <%--<div id="set-content">
                ...
                <div class="Setting" style="padding: 5px 0px;" > <a id="LogOut" href="login.aspx" class="btn btn-default" style="font-family:verdana;font-size:11px; cursor: pointer;"  data-featherlight="ajax">Logout</a></div>
