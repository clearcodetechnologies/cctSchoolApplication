            ...
            <div class="col-md-12">
                ...
                <div class="card-header p-0 pt-1">
                  <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="tab2" data-toggle="pill" href="#tab2Entry" role="tab" aria-controls="tab2Entry" aria-selected="false">Subject Entry</a>
                    </li> 
                  </ul>
                </div>
                <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                   <asp:Label ID="Label3" class="col-form-label" runat="server" Text="Select Standard</"></asp:Label> 
                                    <asp:DropDownList ID="Stdrop1" runat="server" CssClass="form-control"  OnSelectedIndexChanged="Stdrop1_SelectedIndexChanged" TabIndex="2" AutoPostBack="True">
                                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                                        <%-- <asp:ListItem Value="0">---Select---</asp:ListItem>--%>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Stdrop1"
                        ...
                        <div class="col-lg-12 col-md-12">
                             <asp:GridView ID="SubReport" runat="server" AllowSorting="True" AutoGenerateColumns="False" AllowPaging="True" 
                                    CssClass="table table-hover table-bordered cus-table tabular-table "  PageSize="20"   OnPageIndexChanging="SubReport_PageIndexChanging"
                                    OnRowDataBound="SubReport_RowDataBound" 
                                                            OnRowEditing="SubReport_RowEditing" DataKeyNames="intSubject_id"
                                                            OnRowDeleting="SubReport_RowDeleting" OnRowCommand="SubReport_RowCommand" OnSelectedIndexChanged="SubReport_SelectedIndexChanged">
                                    <Columns>                                                                 
                    ...
                    <div class="tab-pane fade" id="tab2Entry" role="tabpanel" aria-labelledby="tab2">
                     <div class="form-horizontal">
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                   <asp:Label ID="Label4" class="col-form-label" runat="server" Text="Select Standard"></asp:Label> 
                                    <asp:DropDownList ID="Standard_id" runat="server" CssClass="form-control">
                                        <%-- <asp:ListItem Value="0">---Select---</asp:ListItem>--%>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Standard_id"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                  <asp:Label ID="Label2" runat="server"  class="col-form-label"  Text="Enter Subject"></asp:Label> 
                                   <asp:TextBox ID="text1" runat="server" AutoComplete="Off" CssClass="form-control" MaxLength="75"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="text1"
                                 ...
                                 <div class="col-lg-3 col-md-4 col-sm-6">
                                 <asp:Button ID="Button1" runat="server" CssClass="btn btn-success btn-sm mt-18" OnClick="Button1_Click" OnClientClick="return ConfirmInsertUpdate();"
                                    Text="Submit"/>
