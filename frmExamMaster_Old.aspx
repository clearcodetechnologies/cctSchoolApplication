<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmExamMaster_Old.aspx.cs" Inherits="frmExamMaster" Title="VClassrooms" %>
                     ...
                     <div class="form-horizontal">
                            <div class="row">
                              ...
                              <div class="form-group">
                                   <asp:Label ID="Label5" class="col-form-label" runat="server" Text="Standard"></asp:Label> 
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlSTD"
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                  <asp:Label ID="Label3" runat="server"  class="col-form-label"  Text="Exam"></asp:Label> 
                                   <asp:TextBox ID="txtExam" runat="server" AutoComplete="Off" CssClass="form-control" MaxLength="3"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtExam"
                                 ...
                                 <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                  <asp:Label ID="Label1" runat="server"  class="col-form-label"  Text="Passing Marks"></asp:Label> 
                                   <asp:TextBox ID="txtPassing" runat="server" AutoComplete="Off" CssClass="form-control" MaxLength="3"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassing"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                  <asp:Label ID="Label2" runat="server"  class="col-form-label"  Text="Total Marks"></asp:Label> 
                                   <asp:TextBox ID="txtMax" runat="server" AutoComplete="Off" CssClass="form-control" MaxLength="3"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtMax"
                      ...
                      <div class="tab-pane fade show active" id="custom-tabs-five-overlay" role="tabpanel" aria-labelledby="custom-tabs-five-overlay-tab">
                           <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                   <asp:Label ID="Label6" class="col-form-label" runat="server" Text="Standard"></asp:Label> 
                                    <asp:DropDownList ID="drpSTD" runat="server" CssClass="form-control" OnSelectedIndexChanged="drpSTD_SelectedIndexChanged" AutoPostBack="True">
                                         <asp:ListItem Value="0" Text="---Select---"></asp:ListItem>
                                    </asp:DropDownList>                                   
                                </div>
                             </div>
                        <div class="col-lg-12 col-md-12">
                             <asp:GridView ID="grdExam" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    CssClass="table table-hover table-bordered cus-table tabular-table "  PageSize="20"  DataKeyNames="intExam_id" EmptyDataText="No Records Found" 
