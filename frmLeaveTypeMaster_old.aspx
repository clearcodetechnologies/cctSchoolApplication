<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmLeaveTypeMaster_old.aspx.cs" Inherits="frmLeaveTypeMaster" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmLeaveTypeMaster.aspx">Leave Type Master</a></li>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:DropDownList ID="drpRole" runat="server" AutoPostBack="True" 
                                                            onselectedindexchanged="drpRole_SelectedIndexChanged" ></asp:DropDownList>
                                                    </td>
                                                </tr>  
                                                </table>
                                                <table width="100%" >
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                CssClass="table  tabular-table " PageSize="20" Width="50%" style="margin:0 0 0 2%;"
                                                                DataKeyNames="intLeaveType_id" onrowdeleting="grvDetail_RowDeleting" 
