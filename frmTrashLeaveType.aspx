<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashLeaveType.aspx.cs" Inherits="frmTrashLeaveType" %>
...
<div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Leave Type Master</li>
        </ol>
    </div>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intLeaveType_id" onrowediting="grvDetail_RowEditing">
                                                                <Columns>
