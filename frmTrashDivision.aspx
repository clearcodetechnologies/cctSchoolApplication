<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashDivision.aspx.cs" Inherits="frmTrashDivision" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intDivision_id" onrowediting="grvDetail_RowEditing" 
                                                                >
                                                                <Columns>
