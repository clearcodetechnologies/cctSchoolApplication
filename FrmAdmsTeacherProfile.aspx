<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmAdmsTeacherProfile.aspx.cs"
    MasterPageFile="~/MasterPage2.master" Inherits="FrmAdmsTeacherProfile" Title="Teacher Profile"
    Culture="es-MX" %>
...
<div class="content-header pd-0">
        ...
        <li><a >Profile <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>                  
            ...
            <li class="active1"><a href="FrmAdmsTeacherProfile.aspx">Teacher Detail</a></li>
                    ...
                    <div class="box-header">
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-1 text-right" style="margin: 10px 0 0 0px; padding:0; font-size:12px;">                              
                            <asp:Label ID="lblTeacherNm" runat="server" Text="Teacher Name" CssClass="control-label"></asp:Label>
                            </div>
                        <div class="col-md-3">
