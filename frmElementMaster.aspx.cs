...
public partial class frmElementMaster : DBUtility
{
    ...
    protected void filldata()
    {
        try
        {
            ...
            string Disquery = "Execute dbo.usp_Area @command='GridElements',@intSchool_id='" + Session["School_id"] + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Button1.Text == "Submit")
            {
                ...
                strQry = "exec [usp_Area] @command='checkElementsExists',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "'";
    ...
    protected void Stdrop1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string Disquery2 = "Execute dbo.usp_Area @command='GridElements',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + query2 + "'";
