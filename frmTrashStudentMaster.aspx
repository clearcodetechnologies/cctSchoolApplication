<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashStudentMaster.aspx.cs" Inherits="frmTrashStudentMaster" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                >
                                                                <Columns>
                                                                <asp:BoundField DataField="intStudent_id" HeaderText="intStudent_id" 
                                                                        ReadOnly="True" Visible="False" />
                                                                <asp:BoundField DataField="vchStudentFirst_name" HeaderText="First Name" ReadOnly="True" />
                                                                <asp:BoundField DataField="vchFatherName" HeaderText="Last Name" ReadOnly="True" />
