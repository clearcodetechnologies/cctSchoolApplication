<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmVacationTypeMaster_Old.aspx.cs" Inherits="frmVacationTypeMaster" %>
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="36%" style="text-align: right; margin:0 0 0 2%;">
                                                        ...
                                                        <td>&nbsp;</td>
                                                            ...
                                                            <table width="100%">
                                                            <tr>
                                                                <td align="right" style=""><asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="vclassrooms_send"
