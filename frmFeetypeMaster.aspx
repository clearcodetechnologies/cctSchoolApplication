<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmFeetypeMaster.aspx.cs" Inherits="frmFeetypeMaster" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intFeetype_id" onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing"
                                                                >
                                                                <Columns>
                                    ...
                                    <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="36%" style="text-align: right; margin:0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label2" runat="server" Text="">FeeType<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                     ...
                                                     <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label8" runat="server" >Frequency<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtFrequency" runat="server" CssClass="input-blue" MaxLength="5" onkeypress="return isNumberKey(event)" AutoComplete="Off"></asp:TextBox>
                                                        </td>
                                                    </tr
                                                    <tr>
                                                        <td align="left">
