<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashHostelFloor.aspx.cs" Inherits="frmTrashHostelFloor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Hostel Floor</li>
        </ol>
    </div>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="HostelFloor_id" onrowediting="grvDetail_RowEditing">
                                                                <Columns>
