<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmHeadwisefee.aspx.cs" Inherits="frmHeadwisefee" %>
                                                        ...
                                                        <td id="Td5" style="padding: 10px 0 20px 0;" align="center" runat="server">
                                                            ...
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                <asp:BoundField DataField="StudentName" HeaderText="Student Name" ReadOnly="True" />
                                                                    <asp:BoundField DataField="Admission Fee" HeaderText="Admission Fee"  ReadOnly="True" />
                                                                    <asp:BoundField DataField="Annual Fee" HeaderText="Annual Fee"  ReadOnly="True" />
                                                                    <asp:BoundField DataField="Exam Fee" HeaderText="Exam Fee" ReadOnly="True" />
                                                                    <asp:BoundField DataField="Tuition Fee" HeaderText="Tuition Fee" ReadOnly="True" />
                                                                    <asp:BoundField DataField="Transport Fee" HeaderText="Transport Fee" ReadOnly="True" />
                                                                    <asp:BoundField DataField="Misc" HeaderText="Misc" ReadOnly="True" />
                                                                    <asp:BoundField DataField="Photo and Insurance" HeaderText="Photo and Insurance" ReadOnly="True" />
                                                                    <asp:BoundField DataField="Late Fee" HeaderText="Late Fee" ReadOnly="True" />
