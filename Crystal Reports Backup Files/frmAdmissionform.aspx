<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmAdmissionform.aspx.cs" Inherits="frmAdmissionform" %>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Select">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgDelete" runat="server" CausesValidation="false" 
                                                                                    CommandName="Delete" ImageUrl="~/images/action_success.png" 
                                                                                    OnClientClick="return confirm('Do You Really want to Confirm the Selected Record?');" />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                                </asp:GridView>
            ...
            <table width="40%" style="margin:0 0 0 40%;">
                <tr>
                    ...
                    <td>
                                        ...
                                        CssClass="vclassrooms_send" ID="btnClear" onclick="btnClear_Click" ></asp:Button>
