  ...
  <!-- /.container-fluid --> 
            ...
            <li>
                ...
                <div class="leftbox-features">
                    ...
                    <p>
                        ...
                        method of attendance. The fully automated VClassrooms requires no manual work for registering
            ...
            <li>
                ...
                <div class="leftbox-features">
                    <h4>
                        Transport Module</h4>
                    <p>
                        The VClassrooms system for school management is equipped with the latest school bus
    ...
    <li>
        ...
        <div class="leftbox-features">
            <h4>
                Security Module</h4>
            <p>
                VClassrooms is technologically advanced software that has comprehensive security tools
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                VClassrooms offers information integration and management benefits to all the stakeholders
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                The profile management module of VClassrooms school management software has been designed
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                The VClassrooms module of <strong>school exam management system</strong> fully automates
    ...
    <li>
        ...
        <div class="leftbox-features">
            <h4>
                Inventory Module</h4>
            <p>
                VClassrooms is the most innovative and modern RFID based school management system.
            ...
            <h4>
                Key features and Benefits of VClassrooms Inventory Module</h4>
            <ul class="about-ulli">
            ...
            <p>
                VClassrooms Inventory Module brings perfection at all levels without any scope of errors.
            </p>
        </div>
    </li>
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                ...
                may be on the school campus with their current valuation and purchase price. VClassrooms
                ...
                of an asset. </h4>
                <h4>
                    Key benefits of VClassrooms Fixed Asset Module</h4>
                <ul class="about-ulli">
    ...
    <li>
        ...
        <div class="leftbox-features">
            <h4>
                Syllabus Module</h4>
            <p>
                VClassrooms inbuilt syllabus module is a necessary and significant syllabus viewing
                and a downloading feature that benefits the students, teachers and parents, alike.</h4>
                <h4>
                    Key features of VClassrooms Syllabus Module</h4>
                <ul class="about-ulli">
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                ...
                a truly modern module of VClassrooms for improving the efficiency of a librarian and
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                ...
                <h4>
                    Key Benefits of VClassrooms Reception And Enquiry Module</h4>
                <ul class="about-ulli">
    ...
    <li>
        ...
        <div class="leftbox-features">
            <h4>
                Messaging Module</h4>
            <p>
                The fast and efficient Messaging Module of VClassrooms school management software is
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                VClassrooms consists of a RFID based student tracking system that is combined with
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                ...
                VClassrooms provides for faster access to all information and data which relates to
            ...
            <h4>
                Key Benefits of VClassrooms Information Module</h4>
            <ul class="about-ulli">
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                VClassrooms provides a very interactive and easily navigable dashboard/platform that
    ...
    <li>
        ...
        <div class="leftbox-features">
            ...
            <p>
                VClassrooms has inbuilt Hostel and Mess Management module that can customize and manage
            ...
            <h4>
                Key Benefits of VClassrooms Hostel And Mess Management Software</h4>
            <ul class="about-ulli">
