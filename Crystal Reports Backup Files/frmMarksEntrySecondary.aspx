                            ...
                            <div class="form-horizontal" style="margin-top:15px;">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-3">
                                    <div class="form-group">
                                       <asp:Label ID="Label1" runat="server" Text="Examination" CssClass="col-md-12 p-rl5"></asp:Label>
                                       <div class="col-md-12 p-rl5">
                                         <asp:DropDownList ID="ddlExam1" runat="server" AutoPostBack="True" CssClass="form-control" OnSelectedIndexChanged="ddlExam1_SelectedIndexChanged"  >
                                                            </asp:DropDownList>
                                         <%-- <asp:DropDownList ID="ddlSubCat" runat="server" AutoPostBack="True" CssClass="form-control"
...
<%--                                    <div class="col-md-3">
                                    <div class="form-group">
                                     ...
                                     <div class="col-md-3">
                                    <div class="form-group">
                                       <asp:Label ID="Label4" runat="server" Text="Section" CssClass="col-md-12 p-rl5"></asp:Label>
                                       <div class="col-md-12 p-rl5">
                                       <%--   <asp:DropDownList ID="ddlExam1" runat="server" AutoPostBack="True" CssClass="form-control" OnSelectedIndexChanged="ddlExam1_SelectedIndexChanged"  >
                                                            </asp:DropDownList>--%>
                                                             <asp:DropDownList ID="ddlSubCat" runat="server" AutoPostBack="True" CssClass="form-control"
...
<asp:TabContainer ID="TabContainer1" CssClass="MyTabStyle" runat="server" Width="1250px"
                                ...
                                <HeaderTemplate>PSTRAITS </HeaderTemplate>
                                ...
                                <HeaderTemplate>Club Activity / P.T</HeaderTemplate>
                                <ContentTemplate>
                        ...
                        <ContentTemplate>
                            <center>
                                ...
                                <div class="vclassrooms">
                                    ...
                                    <div class="col-md-6">
                                             <asp:Button ID="btnSubmit" runat="server" CssClass="vclassrooms_send col-md-6" Text="Submit"
                                                    Visible="False" />

                                                <asp:Button ID="btnClear" CssClass="vclassrooms_send col-md-6" runat="server" Text="Clear"
                                                    Visible="False" />                                         
                                     </div>
                            </center>
                        </ContentTemplate>
