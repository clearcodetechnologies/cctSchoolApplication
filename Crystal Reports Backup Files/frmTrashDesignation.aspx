<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashDesignation.aspx.cs" Inherits="frmTrashDesignation" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intDesignation_Id" onrowediting="grvDetail_RowEditing" 
                                                                >
                                                                <Columns>
                                                                                                                                    
                                                                   
                                                                      <asp:BoundField DataField="intRole_Id" HeaderText="Role" ReadOnly="True" />
                                                                    <asp:BoundField DataField="intDepartment" HeaderText="Department" ReadOnly="True" />
