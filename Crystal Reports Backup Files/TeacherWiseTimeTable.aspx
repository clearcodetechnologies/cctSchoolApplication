<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="TeacherWiseTimeTable.aspx.cs" Inherits="TeacherWiseTimeTable" %>
        ...
        <li><a >Report Center <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>     
            ...
            <li> <a href="frmAdmListStudentDetails.aspx"> Student Details </a></li>
                  ...
                  <li><a href="frmTopScoresStudent.aspx"> Top 10 Scores Student</a></li>
                    <li class="active1"><a href="TeacherWiseTimeTable.aspx"> Teacher Wise Time Table</a></li>                  
                        ...
                        <td align="left">
                            <asp:TabContainer ID="TabContainer1" CssClass="MyTabStyle" runat="server" ActiveTabIndex="0"
                                ...
                                <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                    <HeaderTemplate>
                                        TEACHER WISE TIME TABLE</HeaderTemplate>
                                </asp:TabPanel>
                            ...
                            <table class="style1">
                                ...
                                <tr>
                                    <td colspan="4" align="center">
                                        <asp:GridView ID="grdTeach" runat="server" AutoGenerateColumns="true"
                                            CssClass="table  tabular-table " EmptyDataText="No Data Found" 
                                            Width="100%"  OnRowDataBound="grdTeach_RowDataBound" >
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                            <ContentTemplate>
                                                <asp:Button ID="btnExcel" CssClass="vclassrooms_send" runat="server" Text="EXPORT"
