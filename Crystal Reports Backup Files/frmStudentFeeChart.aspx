                                        ...
                                        <div class="vclassrooms" id="Div1">
                                               ...
                                               <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr><td></td>
                                                              <td width="30%">
                                                                <asp:Button ID="btnSubmit" runat="server" CssClass="vclassrooms_send" Text="Make Payment" />
                                                            </td>
                                                             <td width="30%" >
                                                             <asp:Button ID="btnReport" runat="server" CssClass="vclassrooms_send" Text="Report" 
                                                                      />   </td>
                                                        </tr>
