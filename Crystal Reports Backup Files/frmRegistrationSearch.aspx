<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmRegistrationSearch.aspx.cs" Inherits="frmRegistrationSearch" Title="VClassrooms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style type="text/css">
        ...
        .vclassrooms input[type=checkbox]:checked + label::before
        {
            content: "\2714";
            color: #fff;
            height: 1em;
        ...
        .vclassrooms input[type=checklist], input[type=radio]
        {
            display: block;
            width: 16px;
            height: 1.3em;
        ...
        .vclassrooms input.vclassrooms_sends
        {
            width: 100px;
            background: #3498db;
                                    ...
                                    <td id="Td1" runat="server" align="left">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <asp:Button ID="btnSearch" OnClientClick="return validation();" runat="server" Width="30%" CssClass="vclassrooms_sends"
                                        ...
                                        <table runat="server" id="Table1">
                                            <tr id="Tr1" runat="server">
                                                <td id="Td2"  runat="server">
                                                    <asp:Button ID="Button2" runat="server" CssClass="vclassrooms_send" Text="Go" OnClick="Button2_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
