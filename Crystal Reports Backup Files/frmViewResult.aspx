<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmViewResult.aspx.cs" Inherits="frmViewResult" Title="VClassrooms" %>
                    ...
                    <table width="28%">
                        <tr>
                            <td width="50%" align="right">
                                <asp:Button ID="btnSubmit1" runat="server" CssClass="vclassrooms_send" Text="Search"
                                    Visible="true" OnClick="btnSubmit1_Click" />
                            </td>
                            <td width="50%" align="right">
                                <asp:Button ID="btnSub" CssClass="vclassrooms_send" runat="server" Text="Submit"
