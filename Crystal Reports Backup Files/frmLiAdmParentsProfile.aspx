...
.vclassrooms input.vclassrooms_send
        ...
        .vclassrooms input[type=checkbox]:checked + label:after
        {
...
.vclassrooms input[type=radio] + label  
{
    display          :block;
    width            : 8em;
    height           : 1em;
            ...
            <ContentTemplate>
                ...
                <center>
                    ...
                    <fieldset style="width: 500px;">
                        ...
                        <table style="font-weight: bolder; width: 496px; margin: 10px 0;" align="center" class="vclassrooms">
                            <tr>
                    ...
                    <fieldset style="width: 600px;">
                        ...
                        <table style="font-weight: bolder; width: 496px; margin: 10px 0;" align="center" class="vclassrooms">
                                ...
                                <td id="img" runat="server" align="left" colspan="2">
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" style="width: 245px; float: right;"  ChildrenAsTriggers="False" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <br />
                                            <asp:Button    ID="Button1" runat="server" CssClass="vclassrooms_send"   OnClick="Button1_Click"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button    ID="checkprivious1" runat="server" OnClick="checkPrivious1" CssClass="vclassrooms_send"  OnClientClick="if (!validatePage()) {return true;}"
                                        Text="Back" />
                                </td>
                                <td align="right">
                                    <asp:Button    runat="server" Text="next"
                        ...
                        <table style="font-weight: bolder; width: 496px; margin: 10px 0;" align="center" class="vclassrooms">
                            ...
                            <tr>
                                ...
                                <td id="Td1" runat="server" align="center" colspan="2">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" CssClass="vclassrooms_send" style="width:181px; float: right;"  ChildrenAsTriggers="False" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:FileUpload ID="FileUpload2" runat="server"    /><br />
                                            <br />
                                            <asp:Button    ID="Button2" runat="server"   OnClick="Button2_Click" CssClass="vclassrooms_send" 
                                                OnClientClick="if (!validatePage()) {return true;}" Text="Upload File" />&#160;<br />
                                            <br />
                                        </ContentTemplate>
                                        <Triggers>
            ...
            <ContentTemplate>
                <center>
                    ...
                    <fieldset style="width: 624px;">
                        ...
                        <table style="font-weight: bolder; width: 612px; margin: 10px 0; height: 667px;" align="center" class="vclassrooms">
                            <tr>
                                <td rowspan="6" valign="top" >
                            ...
                            <tr>
                                ...
                                <td id="Td2" runat="server" align="left" colspan="2">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" CssClass="vclassrooms_send" style="width: 225px; float: right;"  ChildrenAsTriggers="False" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:FileUpload ID="FileUpload3" runat="server"   /><br />
                                            <br />
                                            <asp:Button    ID="Button3" runat="server"   OnClick="Button3_Click" CssClass="vclassrooms_send" 
                                                OnClientClick="if (!validatePage()) {return true;}" Text="Upload File" />&#160;<br />
                                            <br />
                                        </ContentTemplate>
                                        <Triggers>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button    ID="ButN3" runat="server" OnClientClick="if (!validatePage()) {return true;}"
                                        ...
                                        <asp:Button    ID="Button5" runat="server" CssClass="vclassrooms_send"  OnClientClick="if (!validatePage()) {return true;}"
