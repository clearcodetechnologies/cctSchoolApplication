...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .vclassrooms input.winner-inside
        {
            width: 100%;
            background: #ffff;
            -webkit-border-radius: 5px;
        ...
        .vclassrooms input.vclassrooms_send {
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" ChildrenAsTriggers="False" 
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:Button    ID="Button1" runat="server"   
                                                            OnClick="Button1_Click" CssClass="vclassrooms_send"  style=" position:relative; left: 268px;" OnClientClick="if (!validatePage()) {return true;}" 
                                                            Text="Upload File" />
                                                        &nbsp;<br />
                                                        <br />
                                                    </ContentTemplate>
...
<asp:PostBackTrigger ControlID="Button1" />
                                            ...
                                            <td align="right" colspan="3">
                                                ...
                                                <asp:Button    runat="server"   Text="next"
                                                    ID="ButN1" OnClick="checknextval1" CssClass="vclassrooms_send" ValidationGroup="a1" ></asp:Button   >
                                           </td></tr></table>
                                                     </td></tr>
                                 ...
                                 <tr>
                                            ...
                                            <td align="left">
                                                <asp:Button    runat="server"   OnClientClick="if (!validatePage()) {return true;}" Text="Back"
                                                    ID="ButP2" OnClick="checkPrivious2" CssClass="vclassrooms_send"></asp:Button   >
                                            </td>
                                            <td width="60%"></td>
                                            <td align="right">
            ...
            <asp:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtPassingYear5"
                ...
                <tr id="tr1" runat="server">
                    <td align="center"  nowrap="nowrap" valign="middle" style="position:relative; top:63px;" class="style6" runat="server">  
                       ...
                       <asp:Button    ID="Button4" runat="server" Text="+"   CssClass="vclassrooms_send"  OnClientClick="if (!validatePage()) {return true;}" OnClick="Button4_Click"  />  
                ...
                <tr id="tr2" runat="server" visible="False">
                    <td align="center" nowrap="nowrap" valign="middle" style="position:relative; top:73px;" class="style6" runat="server">
                       <asp:Button    ID="Button5" runat="server" Text="+" CssClass="vclassrooms_send"  OnClick="Button5_Click" OnClientClick="if (!validatePage()) {return true;}" />  
...
<td valign="top" align="center" runat="server" class="auto-style1">
     ...
     <br /><asp:Label ID="txtUniversityv2" runat="server"   Font-Bold="False"></asp:Label>
                ...
                <tr id="tr3" runat="server" visible="False">
                    <td align="center" nowrap="nowrap" valign="middle" style="position:relative; top:73px;" class="style6" runat="server">
                        <asp:Button    ID="Button6" runat="server" Text="+" OnClick="Button6_Click" CssClass="vclassrooms_send" OnClientClick="if (!validatePage()) {return true;}"  />  
...
<td valign="top" align="center" runat="server" class="auto-style1">
         ...
         <br /><asp:Label ID="txtUniversityv3" runat="server"   Font-Bold="False"></asp:Label>
                ...
                <tr id="tr4" runat="server" visible="False">
                    <td align="center" nowrap="nowrap" valign="middle" style="position:relative; top:73px;" class="style6" runat="server">
                        <asp:Button    ID="Button7" runat="server" Text="+" OnClick="Button7_Click"  CssClass="vclassrooms_send" OnClientClick="if (!validatePage()) {return true;}" />  
                        &nbsp;</td>
                    <td align="center" nowrap="nowrap" valign="top" runat="server">
                ...
                <tr>
                    <td align="center" colspan="7">
                        ...
                        <asp:Button    ID="Button2" style="margin-right:10px;"   runat="server" OnClientClick="if (!validatePage()) {return true;}"
                                                    OnClick="submit" CssClass="vclassrooms_send"  Text="Submit"></asp:Button >
                        <asp:Button    ID="Button8"   runat="server" CssClass="vclassrooms_send" OnClick="Updateval" Text="Update"></asp:Button   >
