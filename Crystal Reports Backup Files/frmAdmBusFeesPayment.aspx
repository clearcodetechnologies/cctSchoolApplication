...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style>
    .vclassrooms input[type="image"]{     width: 48%;
    margin: 0 auto;}
    .vclassrooms input{ float:left;}
    .vclassrooms_send{ margin-right:10px !important;}
    </style>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="paymentid" runat="server" Text="Payment" CssClass="vclassrooms_send"
                                            ...
                                            <table width="50%">
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center" style="padding-top: 15px; position:relative; left:13px;">
                                                        <asp:Button ID="b1" runat="server" ValidationGroup="pp" CssClass="vclassrooms_send"
                                                            Text="Submit" OnClick="b1_Click" />
                                                        <asp:Button ID="Update1" runat="server" CssClass="vclassrooms_send" Text="Update"
                                    ...
                                    <center>
                                        <div class="vclassrooms" >
                                            <table style="font-weight: bolder; width: 100%; margin: 10px 0;" align="center">
                                                <tr runat="server">
                                                    <td runat="server">
                                                        <div id="vclassrooms" class="vclassrooms" style="display:none;">
                                                            <table width="80%">
                                                                <tr>
                                                                    <td>
