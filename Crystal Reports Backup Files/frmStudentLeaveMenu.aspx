                                                            ...
                                                            <table width="42%">
                                                                <tr>
                                                                    <td align="ceneter" nowrap="true">
                                                                        <asp:Button CssClass="vclassrooms_send" ID="Button1" runat="server" Text="Save" OnClick="Button1_Click" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:Button CssClass="vclassrooms_send" ID="Button2" runat="server" Text="Clear"
...
.vclassrooms input.vclassrooms_send {
  ...
  .vclassrooms span { margin:0 0 10px 0 !important; }
  .vclassrooms label {
  display: inline;
  float: left;
  color: #000;
...
<!--[if IE 11]>
.vclassrooms input[type=checkbox], input[type=radio]{ background:#f5f5f5 !important; border:0 !important;}
.vclassrooms input[type=radio]{ width:18px !important; height:18px !important; background:#f5f5f5 !important;}
<![endif]-->

.vclassrooms input[type=radio] + label { background: #3498db; color:#fff !important; font-weight:bold; width:115px !important; height:auto; border-radius:5px !important; }
