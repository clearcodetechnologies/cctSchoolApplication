<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmAnnualOutstanding.aspx.cs" Inherits="frmAnnualOutstanding" %>
                                                        ...
                                                        <td id="Td5" style="padding: 10px 0 20px 0;" align="center" runat="server">
                                                            ...
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                <asp:BoundField DataField="Admission Fee" HeaderText="Paid Admission Fee (Rs.)" ReadOnly="True" />
                                                                    ...
                                                                    <asp:BoundField DataField="Annual Fee" HeaderText="Paid Photo and Insurance (Rs.)"  ReadOnly="True" />
                                                                    <asp:BoundField DataField="Total fee" HeaderText="Total fee (Rs.)"  ReadOnly="True" />
                                                                    <%--<asp:BoundField DataField="CurrentReceivableTransportfee" HeaderText="Current receive" ReadOnly="True" />--%>
