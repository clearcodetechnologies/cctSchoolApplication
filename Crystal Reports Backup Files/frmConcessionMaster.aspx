<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmConcessionMaster.aspx.cs" Inherits="frmConcessionMaster" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intConcession_id" onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing"
                                                                >
                                                                <Columns>
                                                                <asp:BoundField DataField="vchConcession_name" HeaderText="Concession Name" ReadOnly="True" />
                                                                 <asp:BoundField DataField="vchConcession_per" HeaderText="Concession Per" ReadOnly="True" />
                                                                  <asp:BoundField DataField="vchConcession_amt" HeaderText="Concession Amt" ReadOnly="True" /> 
                                    ...
                                    <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="36%" style="text-align: right; margin:0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label2" runat="server" Text="">Concession Name<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label4" runat="server" Text="">Select(Per/Amt)<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                             <asp:RadioButton ID="rbPer" AutoPostBack="true" OnCheckedChanged="rbPer_CheckedChanged"   runat="server" Checked="true" Text="Per"/>  
                                                              <asp:RadioButton ID="rbAmt" AutoPostBack="true" OnCheckedChanged="rbAmt_CheckedChanged"  runat="server" Text="Amt"  />
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="lblNamePer" runat="server" >Concession Per<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtNamePer" runat="server" CssClass="input-blue" MaxLength="3" onkeypress="return isNumberKey(event)" AutoComplete="Off"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="lblNameAmt" runat="server" >Concession Amt<font color="red">*</font></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtNameAmt" runat="server" CssClass="input-blue" MaxLength="10" onkeypress="return isNumberKey(event)" AutoComplete="Off"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
