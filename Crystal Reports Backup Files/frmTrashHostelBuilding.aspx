<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashHostelBuilding.aspx.cs" Inherits="frmTrashHostelBuilding" %>
...
<div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Hostel Building</li>
        </ol>
    </div>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="HostelBuilding_id" onrowediting="grvDetail_RowEditing"     >
                                                                <Columns>
