        ...
        <asp:TabPanel runat="server" HeaderText="TabPanel2" ID="TabPanel2">
            ...
            <ContentTemplate>
              ...
              <tr><td colspan="2" align="center">
                  <table><tr><td>
                      <asp:Button    id="id1" runat="server" CssClass="vclassrooms_send"   Text="Approve" OnClick="id1_Click"/><asp:TextBox ID="txt1" Visible="false" runat="server"></asp:TextBox></td></tr>
                            </td></tr></table>
                    </table>
                   </div>
                         </center>
