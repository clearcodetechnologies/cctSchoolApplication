<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmBookEdition.aspx.cs" Inherits="frmBookEdition" %>
...
<style>
 ...
 <div class="content-header pd-0">
        ...
        <li><a >Library Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmBookEdition.aspx">Book Edition</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intBookEdition_id" onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing"
                                                                >
                                                                <Columns>
                                                                 <asp:BoundField DataField="vchBookEdition_name" HeaderText="Book Edition" ReadOnly="True" />
                                    ...
                                    <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="36%" style="text-align: right; margin:0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label2" runat="server" Text="Book Edition"></asp:Label>
                                                        </td>
                                                        <td align="justify">
