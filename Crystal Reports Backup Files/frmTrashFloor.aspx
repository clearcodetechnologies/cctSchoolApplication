<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashFloor.aspx.cs" Inherits="frmTrashFloor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> School Building Floor</li>
        </ol>
    </div>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intFloor_id" onrowediting="grvDetail_RowEditing" >
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Enable">
                                                                     ...
                                                                     <asp:BoundField DataField="vchFloor_name" HeaderText="Floor Name" ReadOnly="True" />
                                                                </Columns>
                                                            </asp:GridView>
                                                        </td>
                                                    </tr>
