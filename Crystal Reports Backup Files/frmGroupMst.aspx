 ...
 <style type="text/css">
  ...
  text-align: center !important;
   ...
   <style type="text/css">
        ...
        .vclassrooms input.vclassrooms_send{background: #3498db !important; border:none; }
                                    ...
                                    <table width="50%">
                                        ...
                                        <tr>
                                            ...
                                            <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="return ConfirmMsg();"
                                                    OnClick="btnSubmit_Click" style="margin-right:10px;:" CssClass="vclassrooms_send" />
                                                <asp:Button ID="btnCancel" runat="server" Text="Cancel" 
                                                    onclick="btnCancel_Click" CssClass="vclassrooms_send" />
                                            </td>
                                        </tr>
