<%@ Page Title="Social Habit Entry" Language="C#" MasterPageFile="~/MasterPage2.master"
    AutoEventWireup="true" CodeFile="frmPersonalTraits.aspx.cs" Inherits="frmPersonalTraits" %>
...
<div class="content-header content-header1 pd-0">
    ...
    <div class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a><i></i>Home</a></li>
            <li><a><i></i>Study</a></li>
            <li class="active">Social Habit</li>
        </ol>
    </div>
    <style>
        .vclassrooms span
                        ...
                        <td align="left">
                            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Width="1015px"
                                                    ...
                                                    <td align="center" colspan="2">
                                                        <asp:GridView ID="SubReport" runat="server" OnPageIndexChanging="SubReport_PageIndexChanging"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="VchName" HeaderText="Personal Traits Name" ReadOnly="True" />
                                ...
                                <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                    <HeaderTemplate>
                                        Social Habit Entry</HeaderTemplate>
                                    <ContentTemplate>
                                        <div class="vclassrooms">
                                            <table style="font-weight: bolder; width: 40%; margin: 10px 0 10px 15px;" align="center">
                                                <tr>
                                                    ...
                                                    <td>                                                  
                                                        ...
                                                        <asp:DropDownList ID="ddlStandard" runat="server" Font-Bold="False"  AutoPostBack="True" OnSelectedIndexChanged="Standard_id_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlStandard"
                                                ...
                                                <%--<tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlDivison" runat="server" Font-Bold="False">
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlDivison"
                                                            ...
                                                            <tr>
                                                                <td align="right">
                                                                    <asp:Button ID="Button1" Style="padding-left: 10px" runat="server" Text="Submit"
                                                                        OnClick="Button1_Click" CssClass="vclassrooms_send" />
                                                                </td>
                                                                <td align="left">
                                                                    <asp:Button ID="Button2" runat="server" Text="Clear" OnClick="Button2_Click" CssClass="vclassrooms_send"
