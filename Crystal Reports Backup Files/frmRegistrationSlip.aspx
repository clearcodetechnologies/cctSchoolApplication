<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmRegistrationSlip.aspx.cs" Inherits="frmRegistrationSlip" Title="VClassrooms" %>
                                ...
                                <table class="style3">
                                    <tr>
                                        <td id="Submit" align="left">
                                            <asp:Button ID="btnSubmit" runat="server" CssClass="vclassrooms_send" Text="Submit" OnClientClick="return validation();"
