<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmStandardWiseFeePaid.aspx.cs" Inherits="frmStandardWiseFeePaid" Title="VClassrooms - Student attendance management system, Fees management, School bus
...
<div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Standard Wise Fee Collection</li>
        </ol>
    </div>
                                                    ...
                                                    <table class="style2">
                                                        <tr>
                                                            <td align="center" colspan="2">
                                                                <asp:GridView ID="grdFeeM" runat="server" AutoGenerateColumns="False" 
                                                                    CssClass="table  tabular-table " EmptyDataText="No Fee Paid Yet" Width="70%">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Pending" HeaderText="Pending" ReadOnly="True">
                                                                            <ItemStyle HorizontalAlign="Right" />
                                                                        </asp:BoundField>
                                                                    </Columns>
                                                                </asp:GridView>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:GridView ID="grdFeeNew" runat="server" AutoGenerateColumns="False" 
                                                                    CssClass="mGridnew" EmptyDataText="No Fee Paid Yet" Visible="False" 
                                                                    Width="100%">
                                                                    <Columns>
                                                                        <asp:BoundField DataField="Standard" HeaderText="Standard" ReadOnly="True">
                                                                        <ItemStyle HorizontalAlign="Center" />
