<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashSportCard.aspx.cs" Inherits="frmTrashSportCard" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                CssClass="table  tabular-table " PageSize="20" Width="35%" 
                                                                DataKeyNames="intSport_card_id" onrowediting="grvDetail_RowEditing" >
                                                                <Columns>
