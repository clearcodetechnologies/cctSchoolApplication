...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style type="text/css">
        .style2
        {
         ...
         .vclassrooms span{ width:80px !important; margin:0 !important; padding:0 10px 0 10px !important; position:relative; top:-5px;} 
    </style>
</asp:Content>
                                                        ...
                                                        <tr>
                                                            <td align="center" colspan="2">
                                                                <table width="50%">
                                                                    <tr>
                                                                        <td valign="top">
                                                                            <asp:Button ID="btnSubmin" runat="server" ValidationGroup="h1" CssClass="vclassrooms_send"
                                                                                OnClick="Submitval" Text="Submit" />
                                                                        </td>
                                                                        <td valign="top">
                                                                            <asp:Button ID="btnClear" runat="server" CssClass="vclassrooms_send" OnClientClick="if (!validatePage()) {return true;}"
