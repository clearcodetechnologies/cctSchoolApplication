<%@ Page Language="C#" MasterPageFile="~/newMasterPage.master" AutoEventWireup="true"
    CodeFile="frmViewHolidaysDisplay.aspx.cs" Inherits="frmViewHolidaysDisplay" Title="ViewHolidayDisplay" %>
                    ...
                    <table id="Table1" visible="false" style="font-weight: bolder; width: 496px; margin: 10px 0;"
                        ...
                        <tr id="TempNo" runat="server">
                            <td id="Td4" align="left" runat="server">
                                <asp:Label ID="Label8" runat="server">Holiday Name</asp:Label>
                            </td>
                        ...
                        <tr id="Tr4" runat="server">
                            <td id="Td18" align="left" runat="server">
                                <asp:Label ID="Label7" runat="server">Type of holiday:</asp:Label>
                            </td>
            ...
            <ContentTemplate>
                <center>
                    <table style="font-weight: bolder; width: 496px; margin: 10px 0;" align="center">
                        ...
                        <tr id="holival0" runat="server" visible="False">
                            <td id="Td7" align="left" style="width: 306px" runat="server">
                                ...
                                <asp:DropDownList ID="DropDownList12" runat="server" Font-Names="Verdana" Font-Size="Small"
                                    ForeColor="Black" MaxLength="50" OnSelectedIndexChanged="Dropholiadmin_SelectedIndexChanged"
                        ...
                        <tr id="holival1" runat="server" visible="False">
                            <td id="Td8" align="left" style="width: 306px; height: 46px;" runat="server">
                                ...
                                <asp:DropDownList ID="DropDownList13" runat="server" Font-Names="Verdana" Font-Size="Small"
                                    ForeColor="Black" MaxLength="50" OnSelectedIndexChanged="Dropholitech_SelectedIndexChanged"
                                    ValidationGroup="b" Height="18px" AutoPostBack="True">
                                    <asp:ListItem Selected="True" Value="Select">-Select-</asp:ListItem>
                                    <asp:ListItem Value="student">Student</asp:ListItem>
                                    <asp:ListItem Value="Teacher">Teacher</asp:ListItem>
                        ...
                        <tr id="gridvalholi" runat="server" visible="False">
                            <td style="padding: 10px 0 20px 0;" runat="server">
                                <asp:GridView ID="Gridholidetails" DataKeyNames="Student Id" runat="server" __designer:wfdid="w36"
                                    EmptyDataText="Record not Found." AutoGenerateColumns="False" AllowSorting="True"
                                    Width="856px" AllowPaging="True" OnPageIndexChanging="Gridholidetails_PageIndexChanging"
                                    OnRowCancelingEdit="Gridholidetails_RowCancelingEdit" CssClass="mGrid" OnRowDeleting="Gridholidetails_RowDeleting"
                                    OnRowEditing="Gridholidetails_RowEditing" 
                                    onrowdatabound="Gridholidetails_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Holiday Name" HeaderText="Holiday Name" />
                                        ...
                                        <asp:BoundField DataField="Type of holiday" HeaderText="Type of holiday" />
                                    </Columns>
