                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" ChildrenAsTriggers="False" 
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:Button    ID="Button1" runat="server"   
                                                            OnClick="Button1_Click" CssClass="vclassrooms_send" OnClientClick="if (!validatePage()) {return true;}" 
                                                            Text="Upload File" />
                                                        &nbsp;<br />
                                                        <br />
                                                    </ContentTemplate>
...
<asp:PostBackTrigger ControlID="Button1" />
                                            ...
                                            <td align="right" width="30px">
                                                <asp:Button    runat="server" CssClass="vclassrooms_send"   Text="next"
                    ...
                    <tr>
                     ...
                     <tr>
                              <td colspan="3">
                                  <table width="100%"><tr>
                                            <td align="left">
                                                <asp:Button    runat="server" CssClass="vclassrooms_send"  OnClientClick="if (!validatePage()) {return true;}" Text="Back"
                                                    ID="ButP2" OnClick="checkPrivious2"></asp:Button   >
                                            </td>
                                            <td width="70%"></td>
                                            <td align="right">
                                                <asp:Button    runat="server" CssClass="vclassrooms_send"   OnClientClick="if (!validatePage()) {return true;}"  Text="next"
            ...
            <asp:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtPassingYear5"
                ...
                <tr id="tr1" runat="server">
                    <td align="center"  nowrap="nowrap" valign="middle" runat="server">  
                       ...
                       <asp:Button    ID="Button4" runat="server" CssClass="vclassrooms_send" Text="+" OnClientClick="if (!validatePage()) {return true;}" OnClick="Button4_Click"  />  
                ...
                <tr id="tr2" runat="server" visible="False">
                    <td align="center" nowrap="nowrap" valign="middle"  runat="server">
                       <asp:Button    ID="Button5" runat="server" Text="+" OnClick="Button5_Click" CssClass="vclassrooms_send" OnClientClick="if (!validatePage()) {return true;}" />  
...
<td valign="top" align="center" runat="server" >
     ...
     <br /><asp:Label ID="txtUniversityv2" runat="server"   Font-Bold="False"></asp:Label>
                ...
                <tr id="tr3" runat="server" visible="False">
                    <td align="center" nowrap="nowrap" valign="middle"  runat="server">
                        <asp:Button    ID="Button6" runat="server" CssClass="vclassrooms_send" Text="+" OnClick="Button6_Click" OnClientClick="if (!validatePage()) {return true;}" style="height: 26px" />  
...
<td valign="top" align="center" runat="server" >
         ...
         <br /><asp:Label ID="txtUniversityv3" runat="server"   Font-Bold="False"></asp:Label>
                ...
                <tr id="tr4" runat="server" visible="False">
                    <td align="center" nowrap="nowrap" valign="middle"  runat="server">
                        <asp:Button    ID="Button7" runat="server" CssClass="vclassrooms_send" Text="+" OnClick="Button7_Click" OnClientClick="if (!validatePage()) {return true;}" />  
                        &nbsp;</td>
                    <td align="center" nowrap="nowrap" valign="top" runat="server">
                ...
                <tr>
                    <td align="center" colspan="6" >
                        ...
                        <asp:Button    runat="server"   OnClientClick="if (!validatePage()) {return true;}" Text="Back"
                                                    ID="Button3" CssClass="vclassrooms_send" OnClick="checkPrivious3"></asp:Button   >
                        </td>
                            <td width="70%"></td><td>
                            <asp:Button    ID="Button2"   runat="server" CssClass="vclassrooms_send" OnClientClick="if (!validatePage()) {return true;}"
...
<td>                    <asp:Label ID="lab1" runat="server" Visible="false"></asp:Label>
                            ...
                            <td><asp:Label ID="lab2" runat="server" Visible="false"></asp:Label>
                                 ...
                                 <td><asp:Button    ID="Button8"   runat="server" CssClass="vclassrooms_send" OnClick="Updateval" Text="Update"></asp:Button   ></td>
                            </tr></table>
