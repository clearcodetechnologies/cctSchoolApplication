<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmNumberWork.aspx.cs" Inherits="frmNumberWork" %>
                        ...
                        <td align="left">
                            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Width="1015px"
                                ...
                                <asp:TabPanel ID="tabpanel2" runat="server">
                                    <HeaderTemplate>
                                        List of Number Work</HeaderTemplate>
                                    <ContentTemplate>
                                                        ...
                                                        <asp:GridView ID="SubReport" runat="server" OnPageIndexChanging="SubReport_PageIndexChanging"
                                                            ...
                                                            <Columns>
                                                               ...
                                                               <%-- <asp:BoundField DataField="intDivision_id" HeaderText="Division" ReadOnly="True" />--%>
                                                                <asp:BoundField DataField="VchName" HeaderText="Number Work Name" ReadOnly="True" />
                                ...
                                <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                    <HeaderTemplate>
                                        Number work Entry</HeaderTemplate>
                                    <ContentTemplate>
                                        <div class="vclassrooms">
