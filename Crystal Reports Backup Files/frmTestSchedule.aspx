...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style type="text/css">
        ...
        .vclassrooms_send{width:100px !important}
                                    ...
                                    <ContentTemplate>
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" CssClass="vclassrooms_send"
                                                        Text="Submit" />
                                                </td>
                                                <td>
                                                </td>
                                                    ...
                                                    <table runat="server" id="Table1">
                                                        <tr runat="server">
                                                            <td runat="server" style="padding-bottom: 0px; padding-left: 100px">
                                                                <asp:Button ID="Button2" runat="server" CssClass="vclassrooms_send" Text="Send" OnClick="Button2_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table runat="server" id="tblEdit" visible="False">
                                                        <tr runat="server">
                                                            ...
                                                            <td style="padding-bottom: 0px; padding-left: 40px" runat="server">
                                                                <asp:Button ID="Button1" runat="server" CssClass="vclassrooms_send" Text="Submit"
