                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td align="left" valign="middle">
                                                    <asp:Button ID="btnClear" Visible="false" runat="server" CssClass="vclassrooms_send" OnClick="btnClear_Click"
                                                        Text="Clear" />
                                                </td>
                                                <td align="left" valign="middle">
                                                    <asp:Button ID="btnSubmin" runat="server" CssClass="vclassrooms_send" OnClick="Submitval"
                                                        Text="Submit" />
                                                </td>
                                            </tr>
                                        </tr>
                                    ...
                                    <div class="vclassrooms">
                                        <table width="70%" style="position: relative;">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <br />
                                                    &nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="Save" CssClass="vclassrooms_send"
