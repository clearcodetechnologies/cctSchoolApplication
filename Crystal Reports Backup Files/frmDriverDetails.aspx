<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    ...
    Title="VClassrooms" Culture="es-MX" %>
                                        ...
                                        <table style="width: 100%">
                                            <tr id="visi1" runat="server">
                                                ...
                                                <td runat="server" width="30%">
                                                    <asp:Button CssClass="vclassrooms_send" Width="70%" ID="Button1" runat="server" Text="Submit"
                                                        OnClick="Button1_Click" />
                                                </td>
                                                <td runat="server" width="30%">
                                                    <asp:Button ID="Button2" CssClass="vclassrooms_send" runat="server" Text="Clear"
                                            ...
                                            <tr id="visi2" runat="server">
                                                ...
                                                <td class="style1" runat="server" width="30%">
                                                    <asp:Button ID="Button3" runat="server" CssClass="vclassrooms_send" Text="Update"
                                                        OnClick="Button3_Click" />
                                                </td>
                                                <td runat="server" width="30%">
                                                    <asp:Button ID="Button4" runat="server" Text="Clear" CssClass="vclassrooms_send"
