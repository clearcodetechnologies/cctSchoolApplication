                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td width="50%">
                                                                                    <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add" CssClass="vclassrooms_send" />
                                                                                </td>
                                                                                <td>
                                                                                    <asp:Button ID="btnRemove" runat="server" CommandName="Delete" CssClass="vclassrooms_send"
                                                                            ...
                                                                            <tr>
                                                                                <td width="50%">
                                                                                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click"
                                                                                        CausesValidation="false" OnClientClick="return Confirm();" CssClass="vclassrooms_send" />
                                                                                </td>
                                                                                <td>
                                                                                    <asp:Button ID="btnCancel" runat="server" CausesValidation="false" CssClass="vclassrooms_send"
