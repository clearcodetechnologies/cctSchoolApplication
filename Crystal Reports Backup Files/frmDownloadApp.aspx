                            ...
                            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel3">
                                ...
                                <ContentTemplate>
                                    <table width="100%">
                                        <tr>
                                            <td valign="top">
                                            <div class="vclassrooms" id="vclassrooms" style="margin-top:15px;">
                                    ...
                                    <table width="60%" >
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" valign="top">
                                                <asp:Button ID="btnSave" runat="server" CssClass="vclassrooms_send" 
                                                    OnClick="btnSave_Click" OnClientClick="return Check();"
                                                    Text="Submit" />
                                            </td>
                                            <td align="left">
                                                <asp:Button ID="btnCancel" runat="server" CausesValidation="False" 
                                                    CssClass="vclassrooms_send" OnClick="btnCancel_Click" Text="Cancel" />
                                            </td>
                                        </tr>
                                    </table>
                                    </div>
