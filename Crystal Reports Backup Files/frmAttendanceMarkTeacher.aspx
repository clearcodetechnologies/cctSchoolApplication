<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmAttendanceMarkTeacher.aspx.cs" Inherits="frmAttendanceMarkTeacher" %>
...
<div class="content-header pd-0">       
        ...
        <li><a >Attendance <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>                  
            ...
            <li class="active1"><a href="frmAttendanceMarkTeacher.aspx">Teacher Attendance Mark</a></li>   
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:GridView ID="grdMarkAttendance" runat="server" AutoGenerateColumns="False" CssClass="table  tabular-table"
                                            DataKeyNames="intTeacher_id,FCMToken"
                                            
                                            EmptyDataText="No Records Found" Width="100%">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Edit" Visible="False">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTestID" runat="server" Text='<%#Eval("intTeacher_id") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="vchfirst_name" HeaderText="Teacher Name">
                                    ...
                                    <td valign="top">
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnSMS" runat="server" CssClass="vclassrooms_Submit" Text="SMS" Visible="False"
