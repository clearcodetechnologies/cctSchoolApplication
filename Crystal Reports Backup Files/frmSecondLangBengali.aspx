<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmSecondLangBengali.aspx.cs" Inherits="frmSecondLangBengali" %>
                        ...
                        <td align="left">
                            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Width="1015px"
                                ...
                                <asp:TabPanel ID="tabpanel2" runat="server">
                                    <HeaderTemplate>
                                        List of Second Language</HeaderTemplate>
                                    <ContentTemplate>
                                                    ...
                                                    <td align="center" colspan="2">
                                                        <asp:GridView ID="SubReport" runat="server" OnPageIndexChanging="SubReport_PageIndexChanging"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="VchName" HeaderText="Second Language Name" ReadOnly="True" />
                                ...
                                <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                    <HeaderTemplate>
                                        Second Language Entry</HeaderTemplate>
                                    <ContentTemplate>
                                        <div class="vclassrooms">
