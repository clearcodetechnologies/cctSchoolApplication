<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="UploadData.aspx.cs" Inherits="UploadData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="container py-3">  
            <h2 class="text-center text-uppercase">Only Student Attendance Upload from Excel </h2>  
            <div class="card">  
