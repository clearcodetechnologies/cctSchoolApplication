    ...
    <div style="padding: 05px 0 0 0">
        ...
        <td align="left" nowrap="nowrap">
            <asp:TextBox ID="txtTeacherID" runat="server" MaxLength="50" 
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtTeacherID"
...
<%--            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender26" runat="server" TargetControlID="txtTeacherID"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" nowrap="nowrap">
                                                            ...
                                                            <asp:TextBox ID="TextBox12" runat="server" CssClass="input-blue" Font-Names="Verdana"
                                                                ForeColor="Black" MaxLength="10" ValidationGroup="b"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intAdmin_id" onrowediting="grvDetail_RowEditing"  >
                                                                <Columns>
