                                                ...
                                                <tr valign="bottom">
                                                    ...
                                                    <td align="left" colspan="3">
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:Button ID="btnSubmit" runat="server" CssClass="vclassrooms_send" OnClick="Button2_Click"
                                                                        OnClientClick="return  confirm();" Text="Submit" />
                                                                </td>
                                                                <td>
                                                                    <asp:Button ID="Button1" runat="server" CssClass="vclassrooms_send" CausesValidation="false"
