<%@ Page Language="C#" MasterPageFile="~/loginMaster.master" AutoEventWireup="true"
    CodeFile="Product.aspx.cs" Inherits="Product" Title="VClassrooms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<ul >
     ...
     <li >
        ...
        <li>
			<a href="pdf/VClassrooms-Brochure.pdf" download target="_blank" aria-haspopup="true">Brochure</a>
			<!--<ul>
				<li><a href="?webdesign">Web Design</a></li>
				<li><a href="?typography">Typography</a></li>
				<li><a href="?frontend">Front-End</a></li>
        ...
        <div class="vclassrooms_content">
            ...
            <p>
                ...
                with VClassrooms, a Simple, Safe & Secured Management Software tool. We have a strong
            ...
            <p>
                VClassrooms has been designed in such a way that it can be used in Schools, Colleges,
