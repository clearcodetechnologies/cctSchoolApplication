                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top">
                                                                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" ValidationGroup="BusMst"
                                                                                    ...
                                                                                    CssClass="vclassrooms_send" />
                                                                            </td>
                                                                            <td align="left" valign="top">
                                                                                <asp:Button ID="btnCancel2" runat="server" CausesValidation="False" CssClass="vclassrooms_send"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="top">
                                                                    <asp:Button ID="btnAssign" runat="server" OnClick="Button1_Click1" Text="Assign"
                                                                        ValidationGroup="BusDevice" CausesValidation="False" CssClass="vclassrooms_send" />
                                                                </td>
                                                                <td align="left" valign="top">
                                                                    <asp:Button ID="btnCan0" runat="server" CausesValidation="False" CssClass="vclassrooms_send"
                                                                        OnClick="btnCancel_Click" Text="Cancel" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="top">
                                                                    <asp:Button ID="btnAssign1" runat="server" Text="Assign" ValidationGroup="BusDevice"
                                                                        CausesValidation="False" OnClick="btnAssign1_Click" CssClass="vclassrooms_send" />
                                                                </td>
                                                                <td align="left" valign="top">
                                                                    <asp:Button ID="btnCancel1" runat="server" CausesValidation="False" CssClass="vclassrooms_send"
                                                                        OnClick="btnCancel_Click" Text="Cancel" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <div class="vclassrooms">
                                                        <table width="60%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:Button ID="Button4" runat="server" CausesValidation="False" CssClass="vclassrooms_send"
                                                                        OnClick="btnCancel_Click" Text="Cancel" />
                                                                </td>
                                                            </tr>
                                                        </table>
