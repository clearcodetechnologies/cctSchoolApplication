<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmHalfYearlyMaster.aspx.cs" Inherits="frmHalfYearlyMaster" %>
...
<div class="content-header pd-0">
        ...
        <li><a >Fee Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmHalfYearlyMaster.aspx">Half Yearly Master</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="int_half_yearly_id" onrowdeleting="grvDetail_RowDeleting" 
                                                                onrowediting="grvDetail_RowEditing"    >
                                                                <Columns>
                                                                 <asp:BoundField DataField="intDuration_Id" HeaderText="Duration Type" ReadOnly="True" />
                                                                <asp:BoundField DataField="vchMonth" HeaderText="Half Yearly Type" ReadOnly="True" />
                                        ...
                                        <ContentTemplate>
                                            <center>
                                                <table width="36%" style="text-align: right">
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="lblType" runat="server" Text="Half Yearly Type"></asp:Label>
                                                        </td>
                                                        <td align="justify">
