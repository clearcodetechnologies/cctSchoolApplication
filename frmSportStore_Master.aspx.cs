...
public partial class frmSportStore_Master :DBUtility
{
    string strQry = "";
    ...
    {
        strQry = "usp_tblSportStore_Master @command='select',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (btnSubmit.Text == "Submit")
        {
            ...
            {
                strQry = "exec [usp_tblSportStore_Master] @command='insert',@vchStore_name='" + Convert.ToString(txtStoreName.Text.Trim()) + "',@vchStore_address='" + Convert.ToString(txtStoreAddress.Text.Trim()) + "',@vchStore_website='" + Convert.ToString(txtWebsite.Text.Trim()) + "',@vchStore_email='" + Convert.ToString(txtEmail.Text.Trim()) + "',@vchStore_contact_no='" + Convert.ToString(txtContactNo.Text.Trim()) + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "',@intInsertedBy='" + Session["User_id"] + "',@insertIP='" + GetSystemIP() + "'";
        ...
        else
        {
            ...
            //else
            //{
                strQry = "exec [usp_tblSportStore_Master] @command='update',@intStore_id='" + Convert.ToString(Session["StoreID"]) + "',@vchStore_name='" + Convert.ToString(txtStoreName.Text.Trim()) + "',@vchStore_address='" + Convert.ToString(txtStoreAddress.Text.Trim()) + "',@vchStore_email='" + Convert.ToString(txtEmail.Text.Trim()) + "',@vchStore_contact_no='" + Convert.ToString(txtContactNo.Text.Trim()) + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "',@intUpdatedBy='" + Session["User_id"] + "',@UpdatedIP='" + GetSystemIP() + "'";
                if (sExecuteQuery(strQry) != -1)
                {
                    fGrid();
    ...
    protected void grvDetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            strQry = "";
            strQry = "exec [usp_tblSportStore_Master] @command='delete',@intStore_id='" + Convert.ToString(Session["StoreID"]) + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "',@intDeletedBy='" + Session["User_Id"] + "',@deletedIP='" + GetSystemIP() + "'";
            if (sExecuteQuery(strQry) != -1)
            {
                fGrid();
    ...
    protected void grvDetail_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            strQry = "";
            strQry = "exec usp_tblSportStore_Master @command='edit',@intStore_id='" + Convert.ToString(Session["StoreID"]) + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "'";
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
