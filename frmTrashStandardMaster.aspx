<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashStandardMaster.aspx.cs" Inherits="frmTrashStandardMaster" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intstandard_id" onrowediting="grvDetail_RowEditing" 
                                                                >
                                                                <Columns>
