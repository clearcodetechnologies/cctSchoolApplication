<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmBookPublicationMaster.aspx.cs" Inherits="frmBookPublicationMaster" %>
...
<style>
 ...
 <div class="content-header pd-0">
        ...
        <li><a >Library Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmBookPublicationMaster.aspx">Book Publication</a></li>
            <li><a href="frmBookAuthorMaster.aspx">Book Author</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intBook_publication_id" 
                                                                onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing"
                                                                >
                                                                <Columns>
                                                                    <asp:BoundField DataField="vchBook_publication_name" HeaderText="Publication-Name" ReadOnly="True" />
                                    ...
                                    <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="60%" style="text-align: right; margin:0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label2" runat="server" Text="Publication Name"></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtPublication_name" runat="server" CssClass="input-blue" 
                                                                MaxLength="50" AutoComplete="Off"></asp:TextBox>
                                                                 <%--<asp:FilteredTextBoxExtender ID="Fbte1" runat="server" TargetControlID="txtPublication_name"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtPublication_name"
                                                                Display="None" ErrorMessage="please Enter publication Name">please Enter publication Name</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtAddress" runat="server" AutoComplete="Off" 
                                                                ...
                                                                <%--    ---<asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender24" runat="server" TargetControlID="txtAddress"
