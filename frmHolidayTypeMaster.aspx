                                ...
                                <asp:TabContainer ID="TabContainer1" CssClass="MyTabStyle" runat="server" 
                                    ...
                                    <table width="36%" style="text-align: right; margin:0 0 0 2%;"><tr><td align="justify">&nbsp;&nbsp;</td><td align="justify">&nbsp;&nbsp;</td></tr><tr><td align="justify"><asp:Label ID="Label2" runat="server" Text="Holiday Type"></asp:Label></td><td align="justify">
                                        <asp:TextBox ID="txtName" runat="server" CssClass="input-blue" MaxLength="50" 
                                            AutoComplete="Off"></asp:TextBox></td></tr><tr><td align="left">&nbsp;&nbsp;</td><td align="left"><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtName"
