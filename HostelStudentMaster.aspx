<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="HostelStudentMaster.aspx.cs" Inherits="HostelStudentMaster" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >Hostel Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="HostelStudentMaster.aspx">Hostel Student Entry</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="HostelSId" onrowdeleting="grvDetail_RowDeleting" 
                                            ...
                                            <table width="50%"  style="text-align: right; margin:0 auto;">
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td align="justify">
                                                    <asp:TextBox ID="txtStudentName" runat="server" AutoComplete="Off" CssClass="input-blue" MaxLength="15" Width="201px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="R1" runat="server" ControlToValidate="txtStudentName"
