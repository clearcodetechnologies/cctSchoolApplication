<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashAcademicYear.aspx.cs" Inherits="frmTrashAcademicYear" %>
...
<div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Acedemic Year</li>
        </ol>
    </div>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intAcademic_id" onrowediting="grvDetail_RowEditing" >
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="status" HeaderText="Statusr" ReadOnly="True" />
                                                                </Columns>
                                                            </asp:GridView>
                                                        </td>
                                                    </tr>
