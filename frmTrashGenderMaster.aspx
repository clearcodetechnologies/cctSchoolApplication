<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTrashGenderMaster.aspx.cs" Inherits="frmTrashGenderMaster" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intGender_Id" onrowediting="grvDetail_RowEditing" 
                                                                >
                                                                <Columns>
