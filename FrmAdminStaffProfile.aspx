                      ...
                      <div class="tab-pane fade show active" id="custom-tabs-five-overlay" role="tabpanel" aria-labelledby="custom-tabs-five-overlay-tab">
                        <div class="form-horizontal">
                            <div class="row">
                             ...
                             <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                      <asp:Label ID="Label36" CssClass="col-form-label" runat="server" Text="Card. no." Font-Bold="False"></asp:Label>
                                   <asp:Label ID="Label37" runat="server" Font-Bold="False"></asp:Label>
                                                            <asp:TextBox ID="txtTeacherID" runat="server" Font-Names="Verdana" CssClass="form-control"
                                                                ForeColor="Black" MaxLength="50" ValidationGroup="b"></asp:TextBox>&nbsp;&nbsp;
                              ...
                              <div class="form-group"> 
                                      <asp:Label ID="Label14" CssClass="col-form-label" runat="server" Text="Date of Birth" Font-Bold="False"></asp:Label>
                                            ...
                                            <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="TextBox7"
                                                ...
                                                Operator="LessThan" SetFocusOnError="True" Type="Date" ValidationGroup="a1">
