...
public partial class frmWorkHabit : DBUtility
{
        ...
        try
        {
            ...
            if (Button1.Text == "Submit")
            {
               ...
               // string intDivision_id = Convert.ToString(Division_id.SelectedValue);
                ...
                strQry = "exec [usp_Area] @command='checkWorkHabitExists',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "'";
    ...
    protected void Stdrop1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string Disquery2 = "Execute dbo.usp_Area @command='GridHabitworkStan',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + query2 + "'";
