...
public partial class frmSecondLangBengali : DBUtility
{
    ...
    protected void filldata()
    {
        try
        {
            string query1 = "Execute dbo.usp_Area @command='SelectSecondLanguagebengaliStan',@intSchool_id='" + Session["School_id"] + "' ";
            bool st = sBindDropDownList(Standard_id, query1, "vchStandard_name", "intstandard_id");

            string query2 = "Execute dbo.usp_Area @command='SelectSecondLanguagebengaliStan',@intSchool_id='" + Session["School_id"] + "' ";
            bool st1 = sBindDropDownList(Stdrop1, query2, "vchStandard_name", "intstandard_id");

            string Disquery = "Execute dbo.usp_Area @command='GridSecondLanguagebengali',@intSchool_id='" + Session["School_id"] + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Button1.Text == "Submit")
            {
                ...
                strQry = "exec [usp_Area] @command='checkSecondLanguagebengaliExists',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "'";
                ...
                {
                    itrque1 = "Execute dbo.usp_Area @command='InsertSecondLanguagebengali',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@fltinsertIP='" + instip + "',@intSchool_id='" + Session["School_id"] + "',@intInsert_By='" + Session["user_id"] + "',@intAcademic_id='" + Session["AcademicID"] + "'";
            ...
            else if (Button1.Text == "Update")
            {
                try
                {
                    ...
                    {
                        itrque1 = "Execute dbo.usp_Area @command='UpdateSecondLanguagebengali',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@IntUpdate_IP='" + Updateip + "',@intSchool_id='" + Session["School_id"] + "',@intUpdate_id='" + Session["user_id"] + "',@id='" + id + "',@intAcademic_id='" + Session["AcademicID"] + "'";

                        int result1 = sExecuteQuery(itrque1);

                        if (result1 != -1)
                        {
                            string display = "Second Language  Update Successfully!";
                            MessageBox(display);
                            Clear();
                            filldata();
    ...
    protected void SubReport_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            string strQry11 = "Execute dbo.usp_Area @command='DeleteSecondLanguagebengali',@id='" + id + "',@intschool_id='" + Session["School_id"] + "',@fltDeleteIP='" + DeleteIP + "',@intDeleted_by='" + Session["user_id"] + "'";
    ...
    protected void SubReport_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            string strQry = "exec dbo.usp_Area @command='EditSecondLanguagebengali',@id='" + id + "',@intschool_id='" + Session["School_id"] + "'";
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
                Button1.Text = "Update";
    ...
    protected void Stdrop1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string Disquery2 = "Execute dbo.usp_Area @command='GridSecondLanguagebengaliStan',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + query2 + "'";
    ...
    //{
    //    string query3 = "Execute dbo.usp_Area @command='SelectSecondLanguageDiv',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + Convert.ToString(Standard_id.SelectedValue) + "'";
