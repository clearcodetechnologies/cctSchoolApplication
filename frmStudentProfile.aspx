<%@ Page Language="C#" MasterPageFile="~/newMasterPage.master" AutoEventWireup="true" Culture="en-Gb"
    CodeFile="frmStudentProfile.aspx.cs" Inherits="frmStudentProfile" Title="Student Profile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     ...
     <tr><td align="left">
    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" CssClass="MyTabStyle"
        Width="1015px">
                        ...
                        <table style="font-weight: bolder; width: 90%;  align="center">
                            ...
                            <td rowspan="6" class="style8" >
                                ...
                                <td align="left"  width="80%" >
                                    ...
                                    <asp:Label ID="lblvn" Width="100%" runat="server" Font-Bold="False"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" nowrap="nowrap" class="style31">
                                    <asp:Label ID="lblvchmake" Width="100%" runat="server" CssClass="textcss" Font-Bold="False">Middle Name</asp:Label>
                                </td>
                                <td align="left" >
                              ...
                              <tr>
                                  <td rowspan="6" >
                                      ...
                                      <asp:Image id="fileImg2" AlternateText="Image" ImageUrl="images/Sample%20Photo1.jpg"
                                                    runat="server" Style="line-height: normal; height: 100px; width: 80px; margin-right: 27px;"
                                                    border="2" ToolTip="Image" />&nbsp;&nbsp;
                                  <td nowrap="nowrap"  class="style29">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="head">
    <style type="text/css">
        ...
        .textcss{ font-size:12px !important;}
        </style>
</asp:Content>
