<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" EnableEventValidation="true" CodeFile="frmColasticActivity_old.aspx.cs" Inherits="frmColasticActivity" %>
                                                    ...
                                                    <td>&nbsp;</td>
                                                        <td align="left">
                                                            <table width="100%">
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:Button ID="btnSubmit" ValidationGroup="a" runat="server" Text="Submit" CssClass="vclassrooms_send"
