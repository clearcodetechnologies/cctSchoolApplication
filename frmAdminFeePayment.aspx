                                                                    ...
                                                                    <tr>
                                                                        <td align="right"style="width:15%">
                                                                            <asp:Label ID="lblstd" runat="server" 
                                                                                Style="position: relative; top: 0px !important; padding:14px 8px" Text="Standard"></asp:Label>
                                                                        </td>
                                                                        <td style="width:35%">
                                                                       ...
                                                                       <td align="right" style="width:15%">
                                                                            <asp:Label ID="Label5" runat="server" 
                                                                                Style="position: relative; top: 0px !important; padding:14px 8px" Text="Division"></asp:Label>
                                                                        </td>
                                                                        <td style="width:35%">
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" 
                                                                    ...
                                                                    OnRowEditing="grvDetail_RowEditing" PageSize="20" Width="95%">
                                                                    <Columns>
                                    ...
                                    <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                        ...
                                        <ContentTemplate>
                                             <div id="myLoadingElement" style="display: none;">
                                               ...
                                               <table width="97%" style="text-align: right; margin:0 0 0 2%;">
                                               
                                                    <tr>
                                                      
                                                      <td align="justify" style="width:22%;">
                                                           <asp:Label ID="Label3" runat="server" >StudentId<font color="red">*</font></asp:Label>
                                                        </td>
                                                        
                                                       
                                                        <td align="justify" style="width:29%;">
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="justify" style="width:29%;">
                                                             ...
                                                             <asp:TextBox ID="txtStanderd" runat="server" CssClass="input-blue" MaxLength="30" AutoComplete="Off"  ></asp:TextBox>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td align="justify" style="width:29%;">
                                                             ...
                                                             <asp:TextBox ID="txtDiv" runat="server" CssClass="input-blue" MaxLength="30" AutoComplete="Off" ></asp:TextBox>
                                                        ...
                                                        <td align="justify" style="width:29%;">
                                                             ...
                                                             <asp:TextBox ID="txtRollNo" runat="server" CssClass="input-blue" MaxLength="30" AutoComplete="Off"  ></asp:TextBox>
