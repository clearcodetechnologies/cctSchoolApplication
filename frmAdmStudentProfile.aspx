...
<table width="48%" style="text-align: right; margin:0 0 0 2%; float:left;">
    ...
    <tr>
     ...
     <tr>
        ...
        <td align="justify">
            <asp:TextBox ID="txtStudentID" runat="server" MaxLength="30" 
              Width="225px" CssClass="input-blue" ForeColor="Black" ValidationGroup="b"></asp:TextBox>
        ...
        <tr>
            <td align="left" colspan="2">
                <table style="margin:0 0 0 40%;" width="40%">
                    <tr>
                        <td align="right">
                            <asp:Button ID="btnSubmit" runat="server" CssClass="efficacious_send" OnClick="btnSubmit_Click" OnClientClick="return ConfirmInsertUpdate();" Text="Submit" />
                        </td>
                        <td>
                            <asp:Button ID="btnClear" runat="server" CssClass="efficacious_send" OnClick="btnClear_Click" OnClientClick="return ConfirmInsertUpdate();" Text="Clear" />
                        </td>
