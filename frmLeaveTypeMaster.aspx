<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmLeaveTypeMaster.aspx.cs" Inherits="frmLeaveTypeMaster" %>
                      ...
                      <div class="row">
                              ...
                              <div class="form-group">
                                   <asp:Label ID="Label3" class="col-form-label" runat="server" Text="Role"></asp:Label> 
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drpRole"
                                        Display="None" ErrorMessage="Please select role"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-lg-12 col-md-12">
                             <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    CssClass="table table-hover table-bordered cus-table tabular-table "  PageSize="20"  DataKeyNames="intLeaveType_id" onrowdeleting="grvDetail_RowDeleting" 
                     ...
                     <div class="form-horizontal">
                            <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                   <asp:Label ID="Label4" class="col-form-label" runat="server" Text="Leave Type"></asp:Label> 
                                    <asp:TextBox ID="txtName" runat="server" AutoComplete="Off" CssClass="form-control" MaxLength="75"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                                        Display="None" ErrorMessage="Please Enter Leave Type"></asp:RequiredFieldValidator>
