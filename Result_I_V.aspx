                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding-right: 0px" valign="middle">
                                                        <asp:DropDownList ID="ddlSTD" runat="server" AutoPostBack="True" CssClass="textsize"
                                                            ...
                                                            <asp:ListItem Value="3" Text="I"></asp:ListItem>
                                                            <asp:ListItem Value="4" Text="II"></asp:ListItem>
                                                            <asp:ListItem Value="5" Text="III"></asp:ListItem>
                                                            <asp:ListItem Value="6" Text="IV"></asp:ListItem>
                                                            <asp:ListItem Value="7" Text="V"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="center" valign="middle">
