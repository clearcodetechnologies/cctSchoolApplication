        ...
        <asp:UpdatePanel ID="up2" runat="server">
            ...
            <asp:ModalPopupExtender ID="modalPopup" runat="server" TargetControlID="UpdateProgress1"
                ...
                <table>
                    ...
                    <tr>
                        <td align="left">
                            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4" Width="1015px"
                                CssClass="MyTabStyle">
                                                        ...
                                                        <td align="left" nowrap="nowrap">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox3"
                                                                ValidationGroup="a1" Display="None" ErrorMessage="Please Enter last Name" Font-Bold="False"></asp:RequiredFieldValidator>
                                                                                                         ...
                                                                                                         <tr>
        <td align="left">
            <asp:Label ID="Label36" runat="server" Font-Bold="False" Text="Card. no." Style="font-size: 13px;"></asp:Label>
             <font size="1px" color="red">*</font>
        </td>
        <td align="left" nowrap="nowrap">
            <asp:TextBox ID="txtTeacherID" runat="server" MaxLength="50" 
               CssClass="input-blue" ForeColor="Black" ValidationGroup="b"></asp:TextBox>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtTeacherID"
            ...
            <asp:ValidatorCalloutExtender ID="ValidatorCalloutExtender1"
                                        ...
                                        <div>
                                            <center>
                                                  <table style="font-weight: bolder; width: 70%; margin: 10px 0;" align="center">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="lblstd" runat="server" Font-Bold="False">Standard Name</asp:Label>
                                                        </td>
                                                        <td align="left">
                                                        <asp:DropDownList ID="ddlSTD" runat="server" AutoPostBack="True" Width="212px"
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Label ID="lblDiv" runat="server" Text="Division Name" Font-Bold="False"></asp:Label>
                                                        </td>
                                                        <td align="left">
                                                            <asp:DropDownList ID="ddlDIV"  runat="server" AutoPostBack="True" Width="212px" >
                                                            </asp:DropDownList>
                                                        </td>
                                                   ...
                                                   <%-- <tr>
                                                        <td align="left" class="style3" nowrap="nowrap">
                                                            <asp:Label ID="lblgender" runat="server" Text="Gender" Font-Bold="False"></asp:Label>
                                                        </td>
                                                        <td class="style3" nowrap="nowrap" align="left">
                                ...
                                <asp:TabPanel ID="TabPanel3" runat="server">
                                  ...
                                  <asp:TabPanel HeaderText="g" ID="tab" runat="server">
                                        ...
                                        <ContentTemplate>
                                            <center>
                                            <asp:Button ID="btnExcel" CssClass="btn" Style="margin: 10px;" runat="server" 
                                            OnClick="ExportToExcel_Click" Text="Excel"></asp:Button>
                                                        ...
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                 ...
                                                                 <asp:BoundField DataField="StandardName" HeaderText="Class" ReadOnly="True" />
                                                                  <asp:BoundField DataField="DivisionName" HeaderText="Section" ReadOnly="True" />
