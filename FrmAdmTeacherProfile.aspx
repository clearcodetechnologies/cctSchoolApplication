...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <script type="text/javascript">
         function funcswitchtab() {
             //alert(1);
    $('#custom-tabs-five-normal-tab').click()
    //alert(2);
    $("#custom-tabs-five-normal").addClass("active");
    $("#custom-tabs-five-normal-tab").addClass("active show");
            $("#custom-tabs-five-overlay").removeClass("active");
            $("#custom-tabs-five-overlay-tab").removeClass("show").removeClass("active");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Teacher Master</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card card-primary card-tabs">
                <div class="card-header p-0 pt-1">
                  <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link" id="custom-tabs-five-overlay-tab" data-toggle="pill" href="#custom-tabs-five-overlay" role="tab" aria-controls="custom-tabs-five-overlay" aria-selected="true">   Personal Details </a>
                    </li>
                    <%--<li class="nav-item">
                  ...
                  <div class="tab-content" id="custom-tabs-five-tabContent">
                        ...
                        <div class="form-horizontal">
                            <div class="row">
                              ...
                              <div class="form-group"> 
                                 ...
                                 <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group"> 
                                       <asp:Button runat="server" Text="Next" ID="ButN1" OnClick="checknextval1"  
                                              CssClass="btn btn-success btn-sm mt-18" ValidationGroup="a1"></asp:Button>
                                            ...
                                            <table   class="table table-hover table-bordered cus-table tabular-table ">
                                                ...
                                                <tr id="tr1" runat="server">
                                                    <td align="center" nowrap="nowrap" valign="middle" class="style6">
                                                        <asp:Button ID="Button4" runat="server" Text="+" CssClass="btn btn-success btn-sm" OnClick="Button4_Click"
                                                            OnClientClick="if (!validatePage()) {return true;}" />
                                                       <%-- <button id="Button4" class="btn btn-success btn-sm btnrowgd" 
                                                           Text="+" data-nextid="tr2" type="button" onclick="view_nextRow(this.id)">+</button>--%>
                                                    </td>
                    ...
                    <asp:Button runat="server" OnClientClick="if (!validatePage()) {return true;}" Text="Back"
                        ID="Button3" CssClass="btn btn-success btn-sm" OnClick="checkPrivious3"></asp:Button>
                                                                     
                    <asp:Button ID="Button2" CssClass="btn btn-success btn-sm"  runat="server" OnClientClick="if (!validatePage()) {return true;}"
