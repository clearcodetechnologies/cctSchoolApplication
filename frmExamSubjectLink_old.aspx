<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmExamSubjectLink_old.aspx.cs" Inherits="frmExamSubjectLink" %>
                                                    ...
                                                    <tr>
                                                        <td>
                                                                ...
                                                                <table width="70%" style="margin:0 0 0 2%;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width:10%;">
                                                                            <asp:Label ID="Label12" CssClass="textcss" align="center" runat="server" Text="Standard"></asp:Label>
                                                                        </td>
                                                                        <td style="width:20%;">
