<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmCountryMaster_Old.aspx.cs" Inherits="frmCountryMaster" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmCountryMaster.aspx">Country Master</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intCountry_id" onrowdeleting="grvDetail_RowDeleting1" onrowediting="grvDetail_RowEditing1"
                                                                >
                                                                <Columns>
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="36%" style="text-align: right;margin:0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtCountry" runat="server" CssClass="input-blue" 
                                                                MaxLength="30" AutoComplete="Off"></asp:TextBox>
                                                                 <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender35" runat="server" TargetControlID="txtCountry"
