<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmMonthlyOutstanding.aspx.cs" Inherits="frmMonthlyOutstanding" %>
                                                    ...
                                                    <tr id="listparengrid1" runat="server">
                                                        <td id="Td5" style="padding: 10px 0 20px 0;" align="center" runat="server">
                                                            ...
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                CssClass="table  tabular-table " PageSize="20" Width="100%" DataKeyNames="StudentID" >
                                                                <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Monthfee" HeaderText="Monthly fee(Rs.)"  ReadOnly="True" />
                                                                <asp:BoundField DataField="Tuition Fee" HeaderText="Paid Tuition Fee(Rs.)" ReadOnly="True" />
                                                                   <asp:BoundField DataField="CurrentReceivableMonthfee" HeaderText="Current receivable (Rs.)" ReadOnly="True" />
