<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmPeriod_Master_old.aspx.cs" Inherits="frmPeriod_Master" %>
        ...
        <ContentTemplate>
            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="1015px"
                ...
                <asp:TabPanel ID="tabpanel2" runat="server">
                    ...
                    <ContentTemplate>
                        <div class="vclassrooms" style="margin-top: 10px;">
                            <center>
                                <tr>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" Text="Session" Font-Bold="False"></asp:Label>
                                        </td>
                                        <td style="padding-bottom: 10px">
                                            <asp:DropDownList runat="server" ID="ddlSessionName" Width="90%" Style="float: left; font-weight: normal;"
                                                OnSelectedIndexChanged="ddlSessionName_SelectedIndexChanged" TabIndex="2" AutoPostBack="True">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBox2" runat="server" CssClass="input-blue" Width="90%" Style="float: left"
                                                Font-Bold="False" TabIndex="1"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" align="center" style="padding-top: 15px">
                                            <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="vclassrooms_send"
                                                ...
                                                <asp:Button ID="Button2" Visible="False"
                                                    runat="server" Text="Update" CssClass="vclassrooms_send" OnClick="Button2_Click" /><asp:HiddenField
