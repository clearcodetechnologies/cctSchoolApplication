...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">   Session Master </h1>
          </div>  
          <div class="col-sm-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                             <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    CssClass="table table-hover table-bordered cus-table tabular-table "  PageSize="20"  DataKeyNames="intSession_id"  onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing">
                                    <Columns>                                                                 
                     ...
                     <div class="form-horizontal">
                            <div class="row">
                              ...
                              <div class="form-group">
                                   <asp:Label ID="Label4" class="col-form-label" runat="server" Text="Session"></asp:Label> 
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6">
                              <div class="form-group">
                                   <asp:Label ID="lblfrmtime" class="col-form-label" runat="server" Text="To Time"></asp:Label> 
