                                                    ...
                                                    <ContentTemplate>
                                                        <center>
                                                            <table width="100%">
                                                                <tr>
                                                                    <td width="100%">
                                                                        <div id="vclassrooms" class="vclassrooms" style="width: 80%; margin:auto;">
                                                                            <table width="90%">
                                                                                <tr>
                                                                                    <td style="width:10%;">
                                                                                    ...
                                                                                    <td style="width:10%;">
                                                                                        <asp:Label ID="Label3" runat="server" Text="DIV" Visible="" Style="position: relative; top: 5px;
                                                                                            text-align: center; left: 0px;"></asp:Label>
                                                                                    </td>
                                                                                    <td style="width:20%;">
                                                                                        <asp:DropDownList ID="ddlDIV2" runat="server" AutoPostBack="True"  Visible="" OnSelectedIndexChanged="ddlDIV2_SelectedIndexChanged">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                    <td style="width:10%;">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:GridView ID="grvTopic" runat="server" AllowPaging="True" AllowSorting="True"
                                                                            ...
                                                                            EmptyDataText="Record not Found." OnRowDeleting="grvTopic_RowDeleting" Width="96%" style="margin:0 auto;"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width:10%;">
                                                                        <asp:Label ID="Label6" runat="server" Style="position: relative; top: -5px; text-align: center;"
                                                                            Text="DIV" Visible=""></asp:Label>
                                                                    </td>
                                                                    <td style="width:20%;">
                                                                        <asp:DropDownList ID="ddlDIV4" runat="server" AutoPostBack="True" 
                                                                            Visible="" OnSelectedIndexChanged="ddlDIV4_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td style="width:10%;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="grvSyllabus" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            EmptyDataText="Record not Found." Width="96%" style="margin-left:2%;" PageSize="12" OnRowDeleting="grvSyllabus_RowDeleting"
