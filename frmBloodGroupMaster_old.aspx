<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmBloodGroupMaster_old.aspx.cs" Inherits="frmBloodGroupMaster" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmBloodGroupMaster.aspx">Blood Group Master</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intBlood_group_Id" onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing"
                                                                >
                                                                <Columns>
                                        ...
                                        <ContentTemplate>
                                                ...
                                                <table width="36%" style="text-align: right; margin: 0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtBloodGroup" runat="server" CssClass="input-blue" 
