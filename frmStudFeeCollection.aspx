          ...
          <div class="col-md-1 d-none">
                    ...
                    <asp:TabPanel runat="server" HeaderText="Admission Fee" ID="tabAdmissionFee">
                            ...
                            <ContentTemplate> 
                                <div class="fee-form">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Admission" runat="server" CssClass="efficacious_send" OnClick="AddToFee_Admission_Click" />
                                    </div>
                                </div>                               
                            </ContentTemplate> 
                        </asp:TabPanel>
                     ...
                     <asp:TabPanel runat="server" HeaderText="Annual Fee" ID="TabPanel2">
                            ...
                            <ContentTemplate>   
                                <div class="fee-form">   
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Annual" runat="server" CssClass="efficacious_send" OnClick="AddToFee_Annual_Click"/>
                                    </div>
                                </div> 
                            </ContentTemplate> 
                        </asp:TabPanel>   
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Android" runat="server" 
                                            CssClass="efficacious_send" OnClick="AddToFee_Android_Click"/>
                                    </div>
                                </div>                               
                            </ContentTemplate> 
                        </asp:TabPanel>
                         ...
                         <asp:TabPanel runat="server" HeaderText="Exam Fees" ID="TabPanel12">   
                            ...
                            <ContentTemplate>   
                                <div class="fee-form">   
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-md-3">
                                        <asp:Button ID="AddToFee_Exam" runat="server" CssClass="efficacious_send" 
                        ...
                        <asp:TabPanel runat="server" HeaderText="Tuition Fees" ID="TabPanel6">
                            ...
                            <ContentTemplate>   
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-md-3">
                                        <asp:Button ID="AddToFee_Tuition" runat="server" CssClass="efficacious_send" 
                        ...
                        <asp:TabPanel runat="server" HeaderText="Late Fee" ID="TabPanel5" Visible="false">
                            ...
                            <ContentTemplate>   
                                <div class="fee-form">                                
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Monthly" runat="server" CssClass="efficacious_send" OnClick="AddToFee_Monthly_Click"/>
                                    </div>
                                </div> 
                            </ContentTemplate> 
                        </asp:TabPanel>  
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Trasport" runat="server" 
                                            CssClass="efficacious_send" OnClick="AddToFee_Transport_Click" />
                                    </div>
                                </div>                               
                            </ContentTemplate> 
                        </asp:TabPanel>
                         <asp:TabPanel runat="server" HeaderText="Maintinance Fee" ID="TabPanel10">
                            ...
                            <ContentTemplate>   
                                <div class="fee-form">   
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-md-3">
                                        <asp:Button ID="AddToFee_Misc" runat="server" CssClass="efficacious_send" 
                                ...
                                <%--<div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Photo" runat="server" 
                                            CssClass="efficacious_send" OnClick="AddToFee_photo_Click"/>
                                    </div>
                                </div> 
                            </ContentTemplate> 
                        </asp:TabPanel>  
                                ...
                                <div class="fee-form">   
                                    ...
                                    <div class="col-md-3">
                                        <asp:button text="Add To Fee" ID="AddToFee_Late" runat="server" 
                                            CssClass="efficacious_send" OnClick="AddToFee_Late_Click"/>
                                    </div>
                                </div> 
                            </ContentTemplate> 
                        </asp:TabPanel>  
            ...
            <asp:DropDownList ID="drpPayMode" runat="server" AutoPostBack="True"  CssClass="form-control"
                ...
                <asp:ListItem Text="Bank" Value="3"></asp:ListItem>
                 ...
                 <div class="col-md-2"><asp:Button ID="btnSubmit" runat="server" CssClass="efficacious_send" 
