<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmCategoryMaster.aspx.cs" Inherits="frmCategoryMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">   Categoty Master </h1>
          </div>  
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Master</a></li>
              <li class="breadcrumb-item active"> Categoty Master</li>
            </ol>
          </div> 
        </div> 
      </div> 
                      ...
                      <div class="tab-pane fade show active" id="custom-tabs-five-overlay" role="tabpanel" aria-labelledby="custom-tabs-five-overlay-tab">
                        <div class="col-lg-12 col-md-12">
                             <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                        CssClass="table table table-hover table-bordered cus-table tabular-table " PageSize="20" DataKeyNames="intCat_Id"
                                        OnRowDeleting="grvDetail_RowDeleting" OnRowEditing="grvDetail_RowEditing">
                                        <Columns>
                                            <asp:BoundField DataField="vchCategory" HeaderText="Categoty" ReadOnly="True" />
                     ...
                     <div class="form-horizontal">
                            <div class="row">
                              ...
                              <div class="form-group">
                                  <asp:Label ID="Label2" CssClass="col-form-label" runat="server" Text="Categoty"></asp:Label>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6"> 
                                  <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-success btn-sm mt-18"
                                    ...
                                    <asp:Button ID="btnClear" runat="server"  CssClass="btn btn-danger btn-sm mt-18"  Text="Clear" CausesValidation="False" />
                                </div>
