...
public partial class frmEnglishActivity : DBUtility
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Button1.Text == "Submit")
            {
                ...
                strQry = "exec [usp_Area] @command='checkEnglishActivityExists',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "'";
    ...
    protected void Stdrop1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string Disquery2 = "Execute dbo.usp_Area @command='GridEnglishActivityStan',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + query2 + "'";
