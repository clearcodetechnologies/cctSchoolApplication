...
public partial class frmMarksEntrySecondary : DBUtility
{
    ...
    public void FillMarksGridDynamically()
    {
        try
        {
            ...
            if (ddlExam1.SelectedValue != "0" && ddlExam1.SelectedValue != "")
            {
                ...
                strQry = "exec usp_ExamMarks @type='FillExamSubject',@intstandard_id='" + Convert.ToString(ddlSTD1.SelectedValue) + "',@intSubcat_id='" + ddlSubCat.SelectedValue + "',@intAcademic_id='" + Session["AcademicID"] + "'";
                dsObj = sGetDataset(strQry);
                CountSubject=Convert.ToInt32(dsObj.Tables[0].Rows.Count);
    ...
    protected void btnSubmit1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int i = 0; i < grvMarks.Rows.Count; i++)
            {
                ...
                for (int j = 1; j < (grvMarks.Columns.Count/2); j++)
                {
                    ...
                    //{
                        ...
                        strQry = "exec usp_ExamMarks @type='InsertExamMarks1to8',@intExam_id='" + ddlExam1.SelectedValue + "',@intStudent_id='" + lblStud.Text + "',@intSubcat_id='" + ddlSubCat.SelectedValue + "',@intDivision_id='" + ddlDIV1.SelectedValue + "',@intSchool_id='" + Session["School_id"] + "',@intInsertedBy='" + Session["User_id"] + "',@intAcademic_id='" + Session["AcademicID"] + "',";
            ...
            //for (int i = 0; i < GridView1.Rows.Count; i++)
            //{
            //    int work_subjectId = Convert.ToInt32((GridView1.Columns.Count - 2) / 2) + 1;
