<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="frmChanegePassword_old.aspx.cs" Inherits="frmChanegePassword" Title="Change Password" %>
                                                            ...
                                                            <table width="100%">
                                                                <tr>
                                                                    <td style="width:100%; padding-left:105px;">
                                                                        ...
                                                                        <asp:Button ID="btnsubmit" runat="server" CssClass="vclassrooms_send" OnClick="change_pass" OnClientClick="return TopicValidation()" 
