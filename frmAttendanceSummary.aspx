<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmAttendanceSummary.aspx.cs" Inherits="frmAttendanceSummary" %>
...
<div class="content-header1 pd-0">
        ...
        <li><a >Report Center <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>     
            ...
            <li> <a href="frmAdmListStudentDetails.aspx"> Student Details </a></li>
                  ...
                  <li class="active1"><a href="frmAttendanceSummary.aspx"> Staff Attendance Summary</a></li>                  
                                    ...
                                    <td colspan="6">
                                        <table width="100%" style="padding-right: 30px;">
                                            ...
                                            <td align="left" style="padding-right: 20px;">
                                                ...
                                                <td align="center">
                                                    <asp:DropDownList ID="drpUserType" runat="server" class="form-control searchable" AutoPostBack="True" 
